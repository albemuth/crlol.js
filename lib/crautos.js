...
function _getImage($el) {
    var id = $el.attr('value');
    return baseUrl + '/clasificados/usados/' + id + '.jpg';
}

function _getUrl($el) {
    return baseUrl + '/usados/economicos-useddetail.cfm?c=' + $el.attr('value');
}
